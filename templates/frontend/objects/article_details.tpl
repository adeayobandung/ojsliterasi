		...
		<section class="article-sidebar col-md-3 col-lg-3 col-sm-3 col-xs-12">
			...
			<div class="list-group">
				...
				<div class="panel panel-default issue">
					<div class="panel-heading"><span class="fa fa-file-text-o"></span> {translate key="issue.issue"}</div>
					<div class="panel-body">
				...
				{if $section}
					<div class="panel panel-default section">
						<div class="panel-heading"><span class="fa fa-files-o"></span> {translate key="section.section"}</div>
						<div class="panel-body">
			...
			<section class="article-main">
				...
				{if $article->getAuthors()}
					<div class="authors">
						{foreach from=$article->getAuthors() item=author}
							<div class="author">
								<strong><span class="fa fa-user"></span> {$author->getFullName()|escape}</strong>
								{if $author->getLocalizedAffiliation()}
									<div class="article-author-affilitation">
										<span class="fa fa-university"></span> {$author->getLocalizedAffiliation()|escape}
									</div>
								{/if}
								{if $author->getOrcid()}
									<div class="orcid">
				...
				{if $article->getLocalizedAbstract()}
					<div class="article-summary" id="summary">
						<h3><span class="fa fa-file-word-o"></span> {translate key="article.abstract"}</h3>
			...
			<section class="article-more-details">
				...
				{if $article->getCitations()}
					<div class="panel panel-default article-references">
						<div class="panel-heading head-article"><span class="fa fa-list-alt"></span> {translate key="submission.citations"}</div>
